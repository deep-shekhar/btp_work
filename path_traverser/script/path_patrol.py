...
waypoints = [  # This is our list of waypoints
    [(0.4, 0.4,0.0), tf.transformations.quaternion_from_euler(0, 0, 325*pi/180)],    # kiri dalam
...
if __name__ == '__main__':
    ...
    for pose in waypoints:   # Loop through each waypoint, sending them as goals
        ...
        # wait for robot to move, but if more than 10 sec, send next goal/waypoint
